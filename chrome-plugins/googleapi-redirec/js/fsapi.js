...
var FireShotAPI =
{
        ...
        installPlugin : function()
        {
				...
				{
						window.open("http://screenshot-program.com/fireshot/install-chrome.php", '_blank');
						window.focus();
				}
        },
   ...
   // Capture web page and *print*
		...
		saveSilent: function (Entire, Path) 
		{
			this.capturePage(Entire, cSilentSave, undefined, Path);	
		},
